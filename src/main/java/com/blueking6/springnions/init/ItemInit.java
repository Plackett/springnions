...
public class ItemInit {
	...
	public static final RegistryObject<Item> ONION_CRATE = ITEMS.register("onion_crate",
			() -> new ItemNameBlockItem(BlockInit.ONION_CRATE.get(),
					new Item.Properties().tab(springnions.SPNION_TAB)));

	public static final RegistryObject<Item> ONION = ITEMS.register("onion",
			() -> new ItemNameBlockItem(BlockInit.ONION_PLANT.get(),
					new Item.Properties().tab(springnions.SPNION_TAB).food(FoodInit.ONION)));
	...
	public static final RegistryObject<Item> ONION_STEW = ITEMS.register("onion_stew",
			() -> new Item(new Item.Properties().tab(springnions.SPNION_TAB).food(FoodInit.ONION_STEW)));
	...
	public static final RegistryObject<Item> SOYMILK_BUCKET = ITEMS.register("soymilk_bucket",
			() -> new BucketItem(FluidInit.SOYMILK,
					new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(springnions.SPNION_TAB)));
